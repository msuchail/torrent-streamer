...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="bg-gray-900">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset("videojs-chromecast/silvermine-videojs-chromecast.css") }}">
    ...
    <script src="{{ asset('videojs-chromecast/silvermine-videojs-chromecast.min.js') }}"></script>
